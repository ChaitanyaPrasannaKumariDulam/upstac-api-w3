...
public class TestRequestService {
    ...
    public TestRequest findByRequestID(Long id) {
        TestRequest testRequest = testRequestRepository.findByRequestId(id).orElseThrow(() -> new AppException("Invalid ID or State"));
        return testRequest;
    }
